...
namespace DrupalConnect.Models
{
    ...
    {
        public CreateNodeModel(string title, string datePublished, string startPage, string endPage)
        {
            Title = title;
        ...
        public string ToPostData() 
        {
            ...
            var s =
                ...
                //"form_build_id=form-lY2ZEfxR97HOJo2TFR_kaz88FPBt4k7nd2mBnBBLQ98&" +
                    "form_token=LuwJH4m3XCryMkdzBWwcatatquIfWRunoRNeNthB22E&" + "form_id=journal_article_node_form&",
                    Title);
